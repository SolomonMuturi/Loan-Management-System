...
$pdf->Write(4,'Dunster Credit is a private financial lending organization');
$pdf->Ln();
$pdf-> Cell(20);
$pdf->SetFont('Times','',12);
$pdf->Write(4, 'Taj Mall, Pipeline, 00100 Nairobi');
$pdf->Ln();
$pdf-> Cell(20);
$pdf->SetFont('Times','',12);
$pdf->Write(4,'Phone: 0722 530038');
$pdf->Ln();
$pdf-> Cell(20);
$pdf->SetFont('Times','',12);
$pdf->Write(4,'Email:info@dunstercredit.com');
$pdf->Ln();
$pdf-> Cell(20);
$pdf->SetFont('Times','',12);
$pdf->Write(4,'Web: www.dunstercredit.com');
$pdf-> Cell(20);
$pdf->SetFont('Times','',8);
...
$pdf->Ln(2);			
			...
			$rec = $qry->fetch_assoc();
				...
				$pdf->Cell(80,10,$rec['expected_loan']." Ksh", 1);
				$pdf->Ln();
				...
				$pdf->Cell(80,10,$rec['total_loan']." Ksh", 1);
				$pdf->Ln();
				...
				$pdf->Cell(80,10,$rec['emi_loan']." Ksh/month", 1);
				$pdf->Ln();
