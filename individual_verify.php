            ...
            <div class="card-body">
                ...
                <form action="" class="form" method="POST">
                    ...
                    <div class="form-check">
                        <label class="form-check-label" for="checkbox105">Verified by Branch Officer
                    ...
                    <!-- Commented out "Verified by Head Officer" section -->
                    <!--
                    <div class="form-check">
                        <label class="form-check-label" for="checkbox106">Verified by Head Officer
