...
?>
        ...
        <div class="container">
          ...
          <?php 
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['search'])) {
                ...
                if ($br) {
                    ...
                    echo "<span class='text-center' style='color:red'>Borrower ID not martched or not applicable for loan</span>";
                  }
              }            
           ?>
          ...
          <form action="" method="post" name="myform" id="myform" >
            ...
            <div class="form-group row">
              <label for="loanamount" class="text-right col-2 font-weight-bold col-form-label">Payment amount(weekly)</label>                      
              <div class="col-sm-9">
          ...
          <?php  } ?>
            ...
            <div class="form-group row">
                <label  class="text-right col-2 font-weight-bold col-form-label">Remaining Installment</label>
                 <div class="col-sm-9">
                  <input type="number" name="remain_inst" class="form-control"   value="<?php if(isset($loan['remain_inst'])) echo $loan['remain_inst']; ?>" readonly>
              </div>
            </div> 
            <div class="form-group row">
